...
function calcBMI () {
  ...
  let bmi = null,
      ...
      results1_t = document.getElementById("bmi-results1_title"),
	  results1 = document.getElementById("bmi-results1"),
	  results2_t = document.getElementById("bmi-results2_title"),
	  results2 = document.getElementById("bmi-results2"),
	  results3_t = document.getElementById("bmi-results3_title"),
  ...
  if(bmi < 15){
	...
	results3.innerHTML = "Do something....";
  }
  else if(bmi < 16) {
	results1_t.innerHTML = "BMI:";
    results1.innerHTML = bmi;
